<template>
    <div class="pick-popup z-999" @keyup.esc="btnCloseForm()" tabindex="0">
        <form class="t-popup" ref="form">
            ...
            <footer class="t-popup__footer center-y">
                <m-button
                    ...
                    width="100px"
                    style="border: none"
                    @clickButton="btnCloseForm()"
                    tabindex="12"
                >
                    Hủy
                </m-button>
                <m-button width="100px" @clickButton="btnSaveAsset()" tabindex="11"
                    >Đồng ý</m-button
                >
            </footer>
        </form>
...
export default {
    ...
    methods: {
        ...
        btnSaveAsset() {
            ...
            } else if (this.TransferDepartmentName === '') {
                this.$refs.TransferDepartmentName.focus()
                this.toast_content_warning =
