    ...
    >
        <section class="t-toast br-8 flex-column">
            <main class="t-toast__content center-y">
                ...
                <section class="t-toast--icon-success center" v-if="typeToast === 'update'">
                    <MISAIcon success></MISAIcon>
                </section>
                <section class="t-toast--icon-warning center" v-if="typeToast === 'export'">
                ...
                <div class="message">
                    <p
                        :class="[
                            ...
                            {
                                't-toast--title-14px':
                                    typeToast === 'success' || typeToast === 'update'
                            }
                        ]"
                    >
                    ...
                    <div v-if="moreInfo" class="moreInfo">
                        <div
                            v-if="displayInfo"
                            @click="btnViewInfo"
                            class="t-toast--title-14px view"
                        >
                            Ẩn chi tiết phát sinh
                        </div>
                        <div v-else @click="btnViewInfo" class="t-toast--title-14px view">
